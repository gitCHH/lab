...
class Experiment:
    def __init__(self, type, dir, bench=None, l2_size=None, l2_assoc=None,  section_num_to_use=2):
        self.type = type
        self.dir = dir
        self.bench = bench
    ...
    def l2_mpki(self):
        ...
        for i in range(self.num_cpus()):
                key = 'system.' + str(self.cpu_id(i)) + '.committedInsts'
                num_committed_instructions += (1 if self.stats is None or key not in self.stats else int(self.stats[key]))
