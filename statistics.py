...
def get_PU_runtime(m5out_dir):
    ...
    if len(dump_sequence) <= 0:
        ...
        # print('len(times): ',len(PU_times),'len(seq): ',len(dump_sequence))
...
ratios = [ 0,5,10,15,20,25,30,35,40,45, 50,55,60]
...
workload = '256'
gpu_arch = 'maxwell'
print(bench, workload, gpu_arch)
plot(bench, workload, gpu_arch)
